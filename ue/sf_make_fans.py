...
배치 방식 (layout) — 문헌 근거 (자세히는 docs/FAN-REFERENCES.md)
    "pushpull"  층마다 한쪽 급기 + 반대쪽 배기. **2024년 이후 기준 배치**다.
            Chen 외(2024, Agriculture 14:2227)가 환기 6종을 비교해 층별 측면 급기·측면
            배기(Case 3~6)를 채택했고, 랙을 배기구 쪽에 붙인 Case 6이 풍속·온도·습도
            상대표준편차가 모두 가장 낮았다. Sohn 외(2023)는 베드 길이 방향 급기로
            0.65 m/s·CV 33%, 배기구를 하나 더 두어 CV 10%까지 낮췄다.
    "ends"  베드 양 끝 팬 2대를 같은 방향으로 놓아 방을 한 바퀴 돌린다(온실 HAF 지침).
            대공간 기준이라 다단 재배베드 연구의 표준은 아니다.
...
DEF = {
    "layout": "pushpull",        # pushpull | ends | top | side
    "tilt_deg": 15.0,            # 하방 기울기 — 수평보다 베드 내부 유속이 낫다는 보고
    "per_fan_CMM": 6.0,          # 급기 1대당 풍량 (360 CMH) — 캐노피 0.5 m/s 목표
    "diam_m": 0.20,              # 토출 직경
    "depth_m": 0.08,             # 몸체 두께
...
layout["reference"] = [
    "Chen X 외(2024) Agriculture 14:2227 — 환기 6종 비교, 층별 측면 급기+측면 배기 채택, 랙을 배기구 쪽에 붙인 Case 6이 풍속·온도·습도 상대표준편차 최저",
    "왕 외(2025) Agronomy 15:2326 — 베드에 덕트 통합, 캐노피 0.8 m/s에서 광합성 +17.8%·생체중 +29.6%, 캐노피 온도 -1.3 ℃",
    "Gu & Goto(2024) Agriculture 14:1199 — 유입 풍속을 올리면 정체 구역 62.4% -> 7.2%, 엇갈림 배치로 16.4% -> 13.2%",
    "Jung 외(2026) J Agric Eng 2026.2241 — 컨테이너 다단, 배기구 위치가 최대 인자(기여율 57.78%)",
    "Sohn 외(2023) Comput Electron Agric 215:108363 — 베드 길이 방향 급기 0.65 m/s·CV 33%, 배기구 추가 시 CV 10%",
    "UMass Extension / Farm Energy — 온실 HAF 지침(대공간용): 팬을 같은 방향으로 돌려 순환 고리, 기류 0.25~0.5 m/s",
